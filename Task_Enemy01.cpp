...
namespace Enemy01
{
	...
	{
		this->img = DG::Image::Create("./data/image/kuma.png");
	...
	bool  Object::Initialize()
	{
		...
		this->hitBase = ML::Box2D(-16, -40, 224, 224);
	...
	void  Object::UpDate()
	{
		...
		moveVec.y = (angle/60) + 1;
		moveVec.x = cos(angle/30) + 2;
	...
	BChara::DrawInfo  Object::Anim()
	{
		...
		BChara::DrawInfo imageTable[] = {
			//draw							src
			{ ML::Box2D(-4 , -40, 224, 224), ML::Box2D(224 * 0 ,0, 224, 224), defColor },	//歩行１
			{ ML::Box2D(-20, -40, 224, 224), ML::Box2D(224 * 1, 0, 224, 224), defColor },	//歩行２
			{ ML::Box2D(-20, -40, 224, 224), ML::Box2D(224 * 2, 0, 224, 224), defColor },	//歩行３
			{ ML::Box2D(-20, -40, 224, 224), ML::Box2D(224 * 3, 0, 224, 224), defColor },	//歩行４
	...
	void  Object::Received(BChara*  from_, AttackInfo  at_)
	{
		...
		if (this->hp <= 0)
		{
			ge->effectCreator->CreateEffect(EffectCreate::Object::BOMB, this->pos);
			++ge->score;
			this->Kill();
		}
		else {
