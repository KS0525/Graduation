...
namespace ML
{
	namespace Collsion	//COLLISION
	{
		...
		protected:
			enum class KIND{ Non, AABB, Sphere, OBB };
			KIND  kind;
		public:
			ML::Vec3			pos;	//中心点				ALL?
	...
	//複合図形クラス----------------------------------------------------
		...
		{
		public:
			using SP = shared_ptr<ShapeContainer>;
